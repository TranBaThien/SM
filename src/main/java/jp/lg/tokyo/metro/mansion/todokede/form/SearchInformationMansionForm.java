/*
 * @(#) SearchInformationMansionForm.java
 *
 ...
 * @author nmtan
 */
public class SearchInformationMansionForm implements Serializable {
    ...
    public List<String> getLstSortParameter() {
        return Arrays.asList("届出日（昇順）", "届出日（降順）", "マンション名（昇順)", "マンション名（降順）","住所（昇順）", "住所（降順）");
    }
    ...
    public void setLstSortParameter(List<String> lstSortParameter) {
        this.lstSortParameter = Arrays.asList("届出日（昇順）", "届出日（降順）", "マンション名（昇順)", "マンション名（降順）","住所（昇順）", "住所（降順）");
    }
    ...
    public String toString() {
        return "SearchInformationMansionForm [txtApartmentId=" + txtApartmentId + ", txtApartmentName="
                ...
                + ", previousScreen=" + previousScreen + ", userLogin=" + userLogin + "]";
    }
