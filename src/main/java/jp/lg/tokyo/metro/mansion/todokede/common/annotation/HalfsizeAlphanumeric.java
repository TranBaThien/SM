...
@Documented
@Constraint(validatedBy = HalfsizeAlphanumericValidator.class)
public @interface HalfsizeAlphanumeric {

    String message() default "{ }";

    AlphanumbericType type() default AlphanumbericType.FOR_OTHER;
