/*
 * @(#) NotificationInfoAreaCommonForm.java
 *
 ...
 *
 */
public class NotificationInfoCommonExportForm implements Serializable {
	...
	@HaftSizeNumber
	@MaxSize(val = 4)
	@FieldName("修繕の計画的な実施（大規模な修繕工事）_直近実施年")
	@Position(47)
