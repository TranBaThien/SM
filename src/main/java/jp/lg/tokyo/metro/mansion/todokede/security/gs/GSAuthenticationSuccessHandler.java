/*
 * @(#) GSAuthenticationSuccessHandler.java
 *
...
public class GSAuthenticationSuccessHandler extends BaseAuthenticationHandler implements AuthenticationSuccessHandler {
     ...
     * @throws IOException when redirect response
     */
    ...
    public void onAuthenticationSuccess(HttpServletRequest httpServletRequest,
        ...
        TBL120Entity entity = (TBL120Entity) principal.getEntity();
        ...
        if (!ObjectUtils.isEmpty(errorMessage)) {
            ...
            logger.info(MessageUtil.getMessage(CommonConstants.LOG_LG1020_I, "都区市町村ログイン"));
        ...
        logger.info(MessageUtil.getMessage(CommonConstants.LOG_LG1020_I, "都区市町村ログイン"));
        updateScreenInSession(CommonConstants.SCREEN_ID_GAA0110);
        addUserAuthorityToSession(principal, entity);
        
        httpServletResponse.addCookie(addScreenIdCookie(CommonConstants.SCREEN_ID_GAA0110));
        ...
        if (ChangedPasswordFlag.UNCHANGED.getFlag().equals(entity.getBiginingPasswordChangeFlag())) {
            ...
            redirectStrategy.sendRedirect(httpServletRequest, httpServletResponse, "/GBA0110");
        }

    }

    private void addUserAuthorityToSession(UserPrincipal principal, TBL120Entity tbl120Entity) {
        TBM001Entity tbm001Entity = tbm001DAO.getMunicipalMasterInfo(tbl120Entity.getCityCode());
        principal.getCurrentUserInformation().setUserAuthority(tbm001Entity.getUserAuthority());
    }
