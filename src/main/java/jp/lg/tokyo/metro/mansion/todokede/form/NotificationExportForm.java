 ...
 *
 */
public class NotificationExportForm extends BaseMansionInfoVo implements Serializable {
	private static final long serialVersionUID = 1L;

	@Valid
	private BasicNotificationInfoForm basicReportInfo;
	@Valid
	private NotificationInfoCommonExportForm infoAreaCommon;
	...
	public NotificationInfoCommonExportForm getInfoAreaCommon() {
		return infoAreaCommon;
	}
	public void setInfoAreaCommon(NotificationInfoCommonExportForm infoAreaCommon) {
