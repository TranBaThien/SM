const currentScreenId = "GAA0110";
const chkTermsConditionsKey = "GAA0110_chkTermsConditions";
const LOGIN_PERIOD_SCREEN_ID = "GAA0110_periodScreenId";
...
$(document).ready(function() {
    ...
    $(".gsLoginForm").validationEngine('attach', {
    ...
    $.get(baseUrl + "/GAA0110/notice", function(data, status){
